...
if (!empty($_POST['edit_student']))
{
    ...
    if (!$errors){
        ...
        edit_student($currentName, $data['username'], $data['password'], $data['name'], $data['email'], $data['phone'], $data['role']);
        header("location: student-list.php");
    }
}
